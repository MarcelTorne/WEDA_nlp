...
if __name__ == "__main__":
    ...
    data_path = 'stanfordSentimentTreebank/datasetSentences.txt'
    labels_path = 'stanfordSentimentTreebank/sentiment_labels.txt'
    split_path = 'stanfordSentimentTreebank/datasetSplit.txt'
    dictionary_path = 'stanfordSentimentTreebank/dictionary.txt'
    ...
    train_writer = open('sst2/train_orig.txt', 'w')
    test_writer = open('sst2/test.txt', 'w')
